...
const Signup = () => {
  ...
  const updateCacheusers = (cache, { data }) => {
    ...
    cache.writeQuery({
      query: USERS_QUERY,
      data: { Users: [updatedData, ...currentValue.Users] },
    });
  };
  const [adddetails, { data, loading, error }] = useMutation(INSERT_USERS, {
    variables: {
      Name: name,
      Email: email,
      Gender: gender,
          ...
          <div>
            ...
            <Form.Group className="mb-3" controlId="formBasicPassword">
              ...
              >
                ...
                <option value="Opened" name="Open">
                  Male
                </option>
                <option value="Closed" name="Close">
                  Female
                </option>
              </Form.Select>
            </Form.Group>
